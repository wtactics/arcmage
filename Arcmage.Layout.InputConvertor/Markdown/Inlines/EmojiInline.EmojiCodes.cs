...
namespace Microsoft.Toolkit.Parsers.Markdown.Inlines
{
    ...
    public partial class EmojiInline
    {
        ...
        public static void SetCodesDictionary(Dictionary<string, int> emojiCodesDictionary)
        {
            _emojiCodesDictionary = emojiCodesDictionary;
        }
        ...
        private static Dictionary<string, int> _emojiCodesDictionary = new Dictionary<string, int>
        {
            { "smile", 0x1f604 },
            { "laughing", 0x1f606 },
            { "blush", 0x1f60a },
