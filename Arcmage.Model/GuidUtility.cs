...
namespace Arcmage.Model
{
    public static class GuidUtility
    {
        static GuidUtility()
        {
            ArcmageDomainGuid = Guid.Parse("c934dc24-9056-50a6-8151-6f15f7df9467");
        }


        public static Guid ArcmageDomainGuid { get; private set; }

        public static Guid Create(string name)
        {
            return Create(ArcmageDomainGuid, name, 5);
        }
